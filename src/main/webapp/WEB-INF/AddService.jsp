...
<header>
	...
	<h3>Add Service</h3>
	<form:form action="/Addservice/${username}" method="POST" modelAttribute="addService">
	<table>
	<tr><th>Service Id:</th>
	...
	<tr><th> Service Name:</th>
	    <td><form:select path="serviceName" items="${SerName}" required="required" class="form-control"/></td>
	</tr>
	<tr><th> Service Type:</th>
	    <td><form:select path="serviceType" items="${SerType}" required="required" class="form-control"/></td>
	</tr>
	<tr><th> Organization/Company name:</th>
	    <td><form:input type="String" path="name" required="required" class="form-control"/></td>
	...
	<tr><th> Location:</th>
	    <td><form:input type="String" path="location" required="required" class="form-control"/></td>
	    <td><form:errors path="location"/> </td>
	</tr>
	<tr><th> Medical Store:</th>
	    <td><form:select path="medicalStore" required="required" class="form-control">
	    <form:option value="yes">Yes</form:option>
	    <form:option value="no">No</form:option>
	    </form:select></td>
	    <td><form:errors path="medicalStore"/> </td>
	</tr>
	<tr><th> Ambulance:</th>
	    ...
	    <td><form:errors path="ambulance"/> </td>
	</tr>
	
	<tr><td><input type="submit" value="Add Service" class="btn btn-success link"></td>
