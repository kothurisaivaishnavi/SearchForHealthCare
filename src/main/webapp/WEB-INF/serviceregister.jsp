...
<header>
	...
	<div class="reg">
Register as:<a href="/userregisterpage" class="btn btn-outline-dark link">User</a> <a href="/adminregisterpage" class="btn btn-outline-dark link">Admin</a><br>
	</div>
	<br>
	<form:form method="POST" action="/serviceregister" modelAttribute="service">
	<table>
	<tr><th colspan=2><h4>Please fill in this form to create a Service Provider account.</h4><th></tr>
		<tr>
			<th>Name</th>
		...
		<tr>
			<th>Username</th> <br>
			<td><form:input type="text" path="username" placeholder="Enter Username"
				required="required" class="form-control"  /></td>
		...
		<tr>
			<th>Service Location</th> <br>
			<td><form:input type="text" path="location" required="required" class="form-control"  /></td>
