...
<title>Categories Provided</title>
</head>
<body>
<header>
		<nav class="site-nav">
...
<form:form>
<table>  
<tr><th>Service Id</th><th>Service Name</th><th>Service Type</th><th>Update</th><th>Delete</th></tr>  
   <c:forEach var="cat" items="${list}">   
   <tr>  
   <td>${cat.serviceId}</td>   
   <td>${cat.serviceName}</td>  
   <td>${cat.serviceType}</td>   
   <td><a href="/update/${cat.serviceId}">Update</a></td>  
   <td><a href="/deletecat/${cat.serviceId}">Delete</a></td>  
   </tr>  
   </c:forEach>  
   </table>
   </form:form>
